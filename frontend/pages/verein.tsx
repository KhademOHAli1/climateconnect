//Contrary to all other pages this page is currently only available in german because the association operates mainly in Germany
...
export default function Verein({ bodyContent, headContent }) {
  return (
    <WebflowPage
      noHeader
      hideFooter
...
export async function getServerSideProps(ctx) {
  const WEBFLOW_URLS = {
    de: 'https://climateconnect.webflow.io/climate-connect-deutschland-e-v',
    en: 'https://climateconnect.webflow.io/climate-connect-deutschland-e-v',
  }
