...
export default function getIdeaTexts({ idea, creator }) {
  ...
  return {
    ...
    create_an_idea_first_step_text: {
      ...
      de: 'Teile deine Klimaschutzidee, um Mitstreiter*innen zu finden oder einfach andere zu inspirieren.',
    },
    please_choose_meaningful_idea_title: {
      en: 'Important: Please use a meaningful title for your idea so that everybody instantly understand what it is about.',
      de: 'Wichtig: Bitte gib deiner Idee einen aussagekräftigen Titel, damit jeder sofrt versteht, was gemeint ist.',
    },
    title: {
      en: 'Title',
      de: 'Titel',
    ...
    create_idea_add_metadata_motivation_text: {
      en: "Wow, great Idea! You're almost done and we're excited to see where your idea develops after sharing it!",
      de: 'Wow, coole Idee! Du bist fast fertig und wir sind super gespannt, wie sich deine Idee entwickelt nachdem du sie geteilt hast!',
    },
    go_forward: {
      en: 'Next Step',
      de: 'Weiter',
    ...
    do_you_want_to_join_text: {
      en: 'If you participate you will be added to a group chat will all the other people clicked the "Participate" button. Do you want to participate?',
