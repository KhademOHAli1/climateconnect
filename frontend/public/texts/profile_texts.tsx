...
export default function getProfileTexts({ profile, hubName, locale }) {
  return {
    ...
    signup_step_2_headline: {
      ...
      de: 'Füge deinen Namen und deinen Standort hinzu. So können dich andere finden und wissen, woher du kommst.',
    },
    signup_step_3_headline: {
      en: 'Let the climate community know what you are already doing or which fields interest you the most. By doing this you can contribute to Projects more easily. Choose up to 3 fields.',
      de: 'Lass die Klima-Community wissen, was du schon machst oder welche Themen dich am meisten interessieren. So kannst du einfacher zu Projekten beitragen. Wähle bis zu 3 Bereiche aus.',
    },
    repeat_password: {
      en: 'Repeat Password',
