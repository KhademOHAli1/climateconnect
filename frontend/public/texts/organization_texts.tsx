...
export default function getOrganizationTexts({ organization, locale }) {
  ...
  return {
    ...
    type_required_errror: {
      en: 'Please choose at least one organisation type by clicking the "Add Type" button under the avatar.',
    ...
    how_to_summarize_organization: {
      en: "Give a short summary or what your organisation is doing. Below you'll have more space to describe it. (",
      de: 'Fasse deine Organisation und ihre Aktivitäten kurz zusammen. Unten hast du Platz, sie genauer zu beschreiben. (',
    },
    how_to_describe_organization: {
      en: 'Describe what your organisation is doing, how you work and what impact you have on climate change. Please only use English!',
      de: 'Beschreibe, was deine Organisation macht, wie ihr arbeitet und welchen Einfluss ihr auf den Klimawandel habt.',
    },
    ...
    you_have_not_selected_a_parent_organization_either_untick: {
      en: 'You have not selected a parent organisation. Either untick the sub-organisation field or choose/create your parent organisation.',
    ...
    you_have_successfully_created_an_organization_you_can_add_members: {
      ...
      de: 'Du hast erfolgreich eine Organisation erstellt! Jetzt kannst du den Rest deines Teams hinzufügen.',
    },
    ...
    please_join_org_or_use_diff_name_if_problems_contact: {
      en: ". Please join the organisation or use a different name. If you're having problems please contact ",
      de: '. Bitte trete der Organisation bei oder verwende einen anderen Namen. Falls du Probleme hast, wende dich bitte an ',
    },
