...
export default function getProjectTexts({ project, user, url_slug, locale, creator, hubName }) {
  return {
    ...
    tooltip_my_project_is_part_of_the_prio1_project: {
      de: 'PRIO1 ist das junge Klima-Netzwerk. erfahre mehr unter prio1-klima.net. Wenn du diese Option auswählst, wird dein Projekt auch im PRIO1 Hub angezeigt.',
      en: 'PRIO1 is the young climate network. find out more at prio1-klima.net. If you select this option, your project will also be displayed in the PRIO1 Hub.',
    },
    ...
    add_photo_helptext: {
      en: 'Upload a photo that represents your project. This way other climate protectors can see at a glance what your project is about. It is recommended to use a non-transparent image in 16:9 format.',
    ...
    short_description_helptext: {
      en: 'Summarize your project in fewer than 280 characters. Other climate protectors should be able to grasp what your project wants to achieve.',
      de: 'Fasse dein Projekt in weniger als 280 Zeichen zusammen. Andere Klimaschützer*innen sollen verstehen, was dein Projekt erreichen will.',
    },
    description_helptext: {
      en: 'Describe your project in more detail. What are you exactly doing? What is the climate impact of your project?',
      de: 'Beschreibe dein Projekt genauer. Was machst du genau? Was ist die Klimawirkung deines Projekts?',
    },
    collaboration_helptext: {
      en: 'Select if you are would be open to accept help and work with other climate protectors on your project.',
      de: 'Wähle aus, ob du offen bist, Hilfe anzunehmen und mit anderen Klimaschützer*innen an deinem Projekt zu arbeiten.',
    },
    add_skills_helptext: {
      en: 'If you are looking for someone with specific skills to help you with your project, select these here.',
    ...
    add_connections_helptext: {
      en: 'Add connections that would be helpful for collaborators to have. Specifically this could be connections to organisations that could help accelerate your project.',
      de: 'Füge Connections hinzu, die für Unterstützende hilfreich sein könnten. Konkret könnten dies Connections zu Organisationen sein, die dein Projekt beschleunigen könnten.',
    },
    ...
    there_has_been_an_error_when_trying_to_publish_your_project: {
      en: 'There has been an error when trying to publish your project. Check the console for more information.',
    ...
    event_location_helper_text: {
      en: 'Enter the exact location so others are able to find your event. For online events enter the city or country you are from.',
      de: 'Gib die genaue Adresse an, damit Interessierte deine Veranstaltung finden können. Bei Online-Events einfach die Stadt, in der du wohnst.',
    },
