...
export default function getCommunicationTexts() {
  return {
    sending_message: {
      en: 'Sending message',
      de: 'Sende Nachricht',
    ...
    send_us_your_feedback_about_climate_connect: {
      en: 'Send us your feedback about Climate Connect. You can send us ideas, bug reports, criticism or anything else.',
      de: 'Sende uns dein Feedback zu Climate Connect. Du kannst uns Ideen, Fehlerberichte, Kritik oder alles andere schicken.',
    },
    ...
    how_to_mention_explainer_text: {
      en: 'With "@" (e.g. "@Jesse Doe") you can mention somebody. They will then receive a notification.',
      de: 'Mit "@" (z.B. "@Micha Mustermann") kannst du jemanden erwähnen. Die Person kriegt dann eine Benachrichtigung.',
    },
